...
const ROWS: Array[Dictionary] = [
	...
	{"type": 31, "id": "snowblind", "archetype": "Schemer", "role": "ew", "unlock": 8, "retire": -1, "weight": 0.45, "token_cost": 7, "spawn_budget_cost": 13, "instance_cap": 1, "spawn_min": 1, "spawn_max": 1, "cooldown_sec": 180.0, "stage_cap": 2, "support_body": true},
