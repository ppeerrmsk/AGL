...
const LOWEST_ALT_KILL_INVUL_DURATION := 4.0
const MISSILE_HIT_INVUL_DURATION := 4.0
const KILL_BLOODLUST_DURATION := 7.0
const DAMAGED_BLOODLUST_DURATION := 7.0
const EVADE_MISSILE_OVERLOAD_DURATION := 6.0
const FLARE_OVERLOAD_DURATION := 5.0
const OVERLOAD_DURATION_MULT := 4.0
...
const JAM_SELF_OVERLOAD_DURATION := 3.0     ## JAM 命中至少 1 个敌人 → 自身 OVERLOAD 3s
