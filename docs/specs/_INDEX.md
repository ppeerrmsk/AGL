...
| [systems/squad-cohesion](systems/squad-cohesion.md) | system | draft | ✗ | 小队凝聚学说（友+敌）：焦点开火（地/船/BOSS 饱和、飞机留自由机互掩）+ 维持阵型 + 防游走 leash + 复用 FREE↔FOLLOW 开关；与 squad-ai-escort 共用自由机基础设施 |
