...
| [systems/aircraft-evolution-tree](systems/aircraft-evolution-tree.md) | system | draft | ✗ | 进化科技树具体名单：**5 档恢复（2026-07-19）**T1 起手四选一（+幻影 III）/T2 四代半/T3 五代/T4 现实六代（YF-23/FCAS/GCAP/J-36）/T5 原创超凡（X 系+AX-00 压轴 LV26）/ 每架 ≥3 出口 / 相邻环横跨 / 苏美欧中穿插。**§4 v2 已重连并实装（41 节点树 JSON 全量重生成：逐机 LV + gates 设计值 + 同族血统边 + AX-00 七线汇聚；树冒烟 41 节点全过）** |
