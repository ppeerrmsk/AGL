...
| [systems/aircraft-signature-skills](systems/aircraft-signature-skills.md) | system | done | ✅ | 机体签名技能效果表（41 机每机 1 条）。2026-08-04：X-44 改正面 180°绝对射界并让普通机炮/炮舱子弹贯穿；AX-00 改复制 1 架同型僚机。获取仍由 aircraft-signature-progression 接管。 |
| [systems/aircraft-signature-progression](systems/aircraft-signature-progression.md) | system | done | ✅ | 41 条机体专属技走“亲自获得机体 → 功勋商店揭示/购买 → 每机每局一次 30% 第四槽机会”；失败或跳过后本局消失，普通三轴三卡不被挤占。 |
