...
| 项目 | 权威值 |
|---|---|
| 解锁 / Token / 上限 / 编成 | 3 / 3 / ∞ / 2–3 |
| 机体关键值 | 45；1000/650/205；5G；roll 2.7；accel 30 |
| 雷达 | 2800px/25°/4.0s |
| 武器与防御 | 敌方 V-tier 导弹+火箭；无机炮/flare；普通敌机 HP 运行时封顶 75 |
| 飞行/生存/雷达基准 | A-7 低价攻击机；不读取 resources/player/ |
