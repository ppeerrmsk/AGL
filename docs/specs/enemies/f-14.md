...
- 主循环：双机迎头攻击，8s 通场后强制拉开，拒绝缠斗。

## 2. 数据定义

| 项目 | 权威值 |
|---|---|
| 解锁 / Token / 上限 / 编成 | 7 / 6 / 3 / 固定2 |
| 机体关键值 | 60；2300/980/220；6G；roll 3.0；accel 48 |
| 雷达 | 3800px/25°/3.2s |
| 武器与防御 | 机炮+敌方 V-tier 导弹；flare 1/fail 0.50；普通敌机 HP 运行时封顶 75 |
| 飞行/生存/雷达基准 | MiG-29/F-100；不读取 resources/player/ |
