...
# A-12 Avenger II 常规敌版

## 1. 设计意图

- 互斥原型：Schemer；池角色：ew。身份必须由主循环而非小数值差表达。
- 主循环：窄雷达锥单目标重击后远距换位；不承诺尚未实现的隐身或侧翼寻路。

## 2. 数据定义

| 项目 | 权威值 |
|---|---|
| 解锁 / Token / 上限 / 编成 | 13 / 8 / 2 / 1–2 |
| 机体关键值 | 60；2100/980/200；7G；roll 3.4；accel 50 |
| 雷达 | 4600px/24°/3.2s |
| 武器与防御 | 无机炮；敌方 V-tier 导弹；flare 1/fail 0.15；普通敌机 HP 运行时封顶 75 |
| 飞行/生存/雷达基准 | Su-35 传感器，较弱本体；不读取 resources/player/ |
