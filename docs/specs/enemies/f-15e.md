...
| 项目 | 权威值 |
|---|---|
| 解锁 / Token / 上限 / 编成 | 8 / 6 / 3 / 固定2 |
| 机体关键值 | 60；2350/1000/220；6.5G；roll 3.0；accel 48 |
| 雷达 | 3800px/28°/3.2s |
| 武器与防御 | 机炮+敌方 V-tier 导弹；flare 1/fail 0.50；普通敌机 HP 运行时封顶 75 |
| 飞行/生存/雷达基准 | F-100/MiG-29；不读取 resources/player/ |
...
| 敌版资源 | resources/enemy_f15e.tres |
