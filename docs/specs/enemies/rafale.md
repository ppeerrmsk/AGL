...
# Dassault Rafale 常规敌版

## 1. 设计意图

- 互斥原型：Schemer；池角色：ew。身份必须由主循环而非小数值差表达。
- 主循环：每机最多2个不同直属目标，双射后10s换位。
...
| 机体关键值 | 65；2250/1000/190；7.5G；roll 4.0；accel 54 |
| 雷达 | 4400px/32°/3.0s |
| 武器与防御 | 机炮+敌方 V-tier 导弹；flare 1/fail 0.15；普通敌机 HP 运行时封顶 75 |
| 飞行/生存/雷达基准 | Su-27 本体，机制换持续缠斗；不读取 resources/player/ |
...
| 敌版资源 | resources/enemy_rafale.tres |
