...
| 项目 | 权威值 |
|---|---|
| 解锁 / Token / 上限 / 编成 | 7 / 6 / ∞ / 2–3 |
| 机体关键值 | 60；1900/930/205；7.8G；roll 4.0；accel 55 |
| 雷达 | 3800px/32°/2.8s |
| 武器与防御 | 机炮+敌方 V-tier 导弹；flare 1/fail 0.50；普通敌机 HP 运行时封顶 75 |
| 飞行/生存/雷达基准 | 常规 F/A-18；不读取 resources/player/ |
...
| 敌版资源 | resources/enemy_fa18e.tres |
