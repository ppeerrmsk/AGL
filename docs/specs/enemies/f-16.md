...
| 项目 | 权威值 |
|---|---|
| 解锁 / Token / 上限 / 编成 | 5 / 4 / ∞ / 2–4 |
| 机体关键值 | 50；2200/920/190；7G；roll 3.8；accel 52 |
| 雷达 | 3600px/30°/3.2s |
| 武器与防御 | 机炮+敌方 V-tier 导弹；flare 1/fail 0.50；普通敌机 HP 运行时封顶 75 |
| 飞行/生存/雷达基准 | MiG-23 标准主力；不读取 resources/player/ |
...
| 敌版资源 | resources/enemy_regular_f16.tres |
