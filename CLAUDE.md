...
| `AF03(17)` | AF-03 | **Schemer 电磁炮狙击** | `enemy_af03.tres` + `enemy_railgun.tres`（充能 2.5s, AT_CHARGE_START, dmg 60, range 5500m）| **7** | **1** | 8（事件触发）| 单机 | `_create_enemy` AF03 case | high skill/composure/focus + 极高 self_preservation（玩家近身就跑）|
